...
var filtered = myNumbers.filter(function(element){
	return element > 100;
})
...
total = myNumbers.reduce(function(t, element){
	return t += element;
})
...
forTheLoveOfGeorge = notGeorge.map(function(element){
	element = "George";
	return element;
})
...
var totallyAwesome = people.reduce(function(t, element){
	return t += element.awesomeLevel ;
}, 0);